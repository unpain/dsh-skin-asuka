...
body[data-dsh-asuka-interface]
  ...
  --dsw-alias-bg-base: #f5efea;
  --dsw-alias-bg-layer-1: rgba(250, 247, 242, 0.98);
  --dsw-alias-bg-layer-2: rgba(242, 234, 228, 0.96);
  --dsw-alias-bg-layer-3: rgba(232, 222, 217, 0.96);
  --dsw-alias-bg-overlay: rgba(251, 248, 244, 0.99);
  ...
  --dsw-alias-label-caption: #a78c8e;
  --dsw-alias-brand-text: #861019;
  --dsw-alias-button-elevated-fill: #f8f5f2;
  --dsw-alias-button-floating-fill: #fffaf6;
  --dsw-alias-interactive-bg-active: rgba(229, 37, 33, 0.14);
  --dsw-alias-interactive-bg-hover: rgba(229, 37, 33, 0.08);
  --dsw-specific-selector: rgba(242, 230, 225, 0.96);
...
body[data-dsh-asuka-interface][data-ds-dark-theme]
  ...
  [role='presentation']
  > [role='dialog'][aria-modal='true'] {
  --dsw-alias-bg-base: #130a0d;
  --dsw-alias-bg-layer-1: rgba(24, 14, 17, 0.98);
  --dsw-alias-bg-layer-2: rgba(36, 19, 23, 0.98);
  --dsw-alias-bg-layer-3: rgba(50, 25, 29, 0.98);
  --dsw-alias-bg-overlay: rgba(19, 10, 13, 0.99);
  --dsw-alias-label-primary: #f7ecea;
  --dsw-alias-label-primary-bluish: #ffe0dc;
  --dsw-alias-label-secondary: #d4b6b7;
  --dsw-alias-label-tertiary: #ad8b8e;
  ...
  --dsw-alias-button-elevated-fill: rgba(49, 25, 29, 0.96);
  --dsw-alias-button-floating-fill: rgba(55, 27, 32, 0.98);
  --dsw-specific-selector: rgba(58, 29, 34, 0.96);
  color: var(--dsw-alias-label-primary);
  background: rgba(19, 10, 13, 0.96);
}
